...
public class WalkingOptionsFragment extends Fragment
{
  ...
  private void initViews(@NonNull View root)
  {
    ...
    dirtyRoadsBtn.setEnabled(!RoutingOptions.hasOption(RoadType.Paved, Router.Pedestrian)
                             || RoutingOptions.hasOption(RoadType.Dirty, Router.Pedestrian));
    ...
    pavedBtn.setEnabled(!RoutingOptions.hasOption(RoadType.Dirty, Router.Pedestrian)
                        || RoutingOptions.hasOption(RoadType.Paved, Router.Pedestrian));
