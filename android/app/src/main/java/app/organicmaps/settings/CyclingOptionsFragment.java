...
public class CyclingOptionsFragment extends Fragment
{
  ...
  private void initViews(@NonNull View root)
  {
    ...
    CompoundButton.OnCheckedChangeListener ferryBtnListener = new ToggleRoutingOptionListener(RoadType.Ferry, root, Router.Bicycle);
    ...
    dirtyRoadsBtn.setEnabled(!RoutingOptions.hasOption(RoadType.Paved, Router.Bicycle) || RoutingOptions.hasOption(RoadType.Dirty, Router.Bicycle));
    CompoundButton.OnCheckedChangeListener dirtyBtnListener = new ToggleRoutingOptionListener(RoadType.Dirty, root, Router.Bicycle);
    ...
    CompoundButton.OnCheckedChangeListener stepsBtnListener = new ToggleRoutingOptionListener(RoadType.Steps, root, Router.Bicycle);
    ...
    pavedBtn.setEnabled(!RoutingOptions.hasOption(RoadType.Dirty, Router.Bicycle) || RoutingOptions.hasOption(RoadType.Paved, Router.Bicycle));
    CompoundButton.OnCheckedChangeListener pavedBtnListener = new ToggleRoutingOptionListener(RoadType.Paved, root, Router.Bicycle);
