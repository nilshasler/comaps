...
public class DrivingOptionsFragment extends Fragment
{
  ...
  private void initViews(@NonNull View root)
  {
    ...
    dirtyRoadsBtn.setEnabled(!RoutingOptions.hasOption(RoadType.Paved, Router.Vehicle)
                             || RoutingOptions.hasOption(RoadType.Dirty, Router.Vehicle));
    ...
    pavedBtn.setEnabled(!RoutingOptions.hasOption(RoadType.Dirty, Router.Vehicle)
                        || RoutingOptions.hasOption(RoadType.Paved, Router.Vehicle));
